...
let bothAnimalNames = zooAnimals.forEach(function(i){
...
let lowerPopulationAnimals = zooAnimals.filter((lower) => {
...
let populationTotalList = zooAnimals.reduce((populationTotal, populationAmount) => {
  return populationTotal + populationAmount.population;
}, 0);

console.log(populationTotalList);
